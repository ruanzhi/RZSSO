...
<c:if test="${sessionScope.user==null}">
    <div class="top-wrapper">
        <div class="top-info">
            ...
            <div class="top-right">
                <a class="a-float-left" href="${pageContext.request.contextPath}/person/login"> [登录]</a>
        ...
        <div class="top-info">
            <div class="top-left">
                ...
                <div data-toggle="hidden-box" id="nav-box1" class="user-box">
                    ...
                    <div class="my-grow">
                        <h1><a href="#">账号管理</a>&nbsp;|&nbsp;<a href="${pageContext.request.contextPath}/auth/logout">退出</a></h1>
                        <p>
                ...
                <div data-toggle="hidden-box" id="nav-box2" class="msg-box">
                    ...
                    <div class="read-info">
                        <h2><span class="orange">&nbsp;&nbsp;|</span>&nbsp;你的书架&nbsp;<span style="font-weight: lighter">收到了<span
                                class="orange">1</span>本书</span><span class="fa fa-times close-msg"></span></h2>
            ...
            <%--<div class="user-info">--%>
                <%--<div class="gold-top">--%>
                    ...
                    <%--<div class="inner-user">--%>
                        <%--<h3>Hi 天之狼2011</h3>--%>
                        <%--<a class="get-gold" href="#"><span class="glods"></span><span--%>
                                <%--class="get-money">领淘金币抵钱</span></a>--%>
...
<div class="main">
    ...
    <div class="main-right">
        <div class="time-go">
            <div class="time-cell">
                <h1><a href="#" class="text_shadow">我收藏的店铺上新</a><span class="now-news">更新<span class="">3</span></span>
                </h1>
            ...
            <!--dynamic动态-->
            <div class="dynamic">
                <h3 class="text_shadow">天猫美妆<span>04-19 10:00</span><span class="follow">√&nbsp;<a href="#">已关注</a>&nbsp;|&nbsp;<a
                        href="#">取消</a></span></h3>
...
<div class="footer">
    <div class="footer-right">
        ...
        <p class="gary-text"><span>网络文化经营许可证：文网文[2010]040号</span>|<span>增值电信业务经营许可证：浙B2-20080224-1</span>|<span>信息网络传播视听节目许可证：1109364号</span>
        </p>
        <div class="some-info">
