...
<head>
    ...
    <script src="${pageContext.request.contextPath}/js/wb.js" type="text/javascript" charset="utf-8"></script>
...
<div class="mianCont">
    <div class="top">
        <c:if test="${sessionScope.user==null}">
            <span>您好！欢迎来到17商城 请&nbsp;<a href="${pageContext.request.contextPath}/person/login">[登录]</a>&nbsp;<a
                    href="reg.html">[注册]</a></span>
        </c:if>
        <c:if test="${sessionScope.user!=null}">
            <span><a> ${sessionScope.user.username} </a> 您好！欢迎来到17商城 </span>
           <span class="topRight">
